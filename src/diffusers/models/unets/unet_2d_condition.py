...
class UNet2DConditionModel(
    ...
    def stream_forward(
        ...
        """Run the upstream computation with deferred residuals; return the output tensor."""
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                if is_adapter and len(down_intrablock_additional_residuals) > 0:
                    additional_residuals["additional_residuals"] = get_lazy_tensor(
                ...
                if is_adapter and len(down_intrablock_additional_residuals) > 0:
                    sample += get_lazy_tensor(down_intrablock_additional_residuals.pop(0))
        ...
        if is_controlnet:
            ...
            for down_block_res_sample, down_block_additional_residual in zip(
                ...
                down_block_res_sample = down_block_res_sample + get_lazy_tensor(down_block_additional_residual)
        ...
        if self.mid_block is not None:
            ...
            # Resolve once before inspecting a deferred adapter residual shape.
            if is_adapter and down_intrablock_additional_residuals:
                down_intrablock_additional_residuals[0] = get_lazy_tensor(down_intrablock_additional_residuals[0])
        ...
        if is_controlnet:
            sample = sample + get_lazy_tensor(mid_block_additional_residual)
